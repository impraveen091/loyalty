  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Text style={styles.description}>
        This website is operated by SureScanR, a brand under Big Leap Digital
        Services Pvt Ltd. Throughout the site, the terms “we,” “us,” and “our”
        refer to SureScanR, and ‘’Site’’ refers to www.SureScanR.com. SureScanR
      ...
      <Text style={styles.subheading}>OPTIONAL TOOLS</Text>
      <Text style={styles.description}>
      ...
      <Text style={styles.description}>
        ...
        contest entries or blog comments) or without a request from us you send
      ...
      <Text style={styles.description}>
        ...
        posted by you or any third-party. By voluntarily submitting your
        subscription to the ‘’Landing Page Analysis’’ service of this Site, you
        agree that the work performed by us may be published on the website as a
        case study or in any other way that could promote this service. The
        client will be noticed before or after it’s published to let him know
        when it’s public.
      </Text>
      <Text style={styles.subheading}>PERSONAL INFORMATION</Text>
      <Text style={styles.description}>
        Your submission of personal information through the store is governed by
        our Privacy Policy. Please review our Privacy Policy.
      </Text>
      <Text style={styles.subheading}>ERRORS, INACCURACIES AND OMISSIONS</Text>
      <Text style={styles.description}>
      ...
      <Text style={styles.subheading}>PROHIBITED USES</Text>
      <Text style={styles.description}>
      ...
      <Text style={styles.description}>
        ...
        shall SureScanR, our directors, officers, employees, affiliates, agents,
      ...
      <Text style={styles.description}>
        You agree to indemnify, defend, and hold harmless SureScanR and our
      ...
      <Text style={styles.description}>
        ...
        posted by us on this site or in respect to The Service constitute the
        ...
        us (including, but not limited to, any prior versions of International
        use
      </Text>
      <Text style={[styles.description, {marginBottom: 30}]}>
        ...
        Specifically, you agree to comply with all laws regarding the
